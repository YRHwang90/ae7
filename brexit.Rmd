...
brexit %>% 
  ggplot(aes(x = prop,y=opinion, fill = opinion)) +
...
brexit %>% 
  ...
  labs( 
    ...
    "Wrong" = "#ef8a62",
    "Right" = "#67a9cf",
    "Don't know" = "gray", guide=guide_legend(title="reg")
  )) +
  theme_minimal()
...
p_again = ggplot() + 
  layer(data=diamonds, mapping=aes(x=carat, alpha=0.3),geom="bar", stat = "bin", position="stack")
